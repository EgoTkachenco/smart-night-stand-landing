export default function HomeSpecification() {
	return <div className="home-specification">
		<div className="card">
			...
			<img src="/images/table-4.png" alt="Table" className="specification__image" />
			<div className="specification__subtitle">DESCRIPTION</div>
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. A, volutpat proin ullamcorper in. Malesuada lacus, suspendisse pellentesque turpis erat semper eu. Sed massa arcu, egestas ligula in accumsan. Amet, donec ullamcorper aliquam ut enim.</p>

			<img src="/logo-dark.svg" alt="logo" className="specification__logo" />
		</div>
	</div>
}